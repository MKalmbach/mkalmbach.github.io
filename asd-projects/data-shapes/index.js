$(document).ready(function () {
  ...
  //-----------------------------------------------------------------------
  // TODO 0: I have read over the info to familiarize myself with the project.
  //-----------------------------------------------------------------------
  ...
  //-----------------------------------------------------------------------
  // Loop through each shape in the dataShapes array
  // and add the goodBehavior property based on the color of the shape.
  //-----------------------------------------------------------------------
  ...
  function handleBad(data, repeat) {
    var newRepeat = repeat + 1;

    setBackgroundWithMixed(data, newRepeat);

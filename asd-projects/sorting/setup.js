...
function generateList(list, listId, cssClass, baseId)
{
    ...
    // This will be used to keep track of which values 
    // have already been assigned to created elements
    //
    ...
    {
        // Choose the next element to create randomly 
        // (by grabbing an unused value for the element)
        nextIndex = chooseIndex(nextIndex, numbers);

        // create & add the element
...
// Create element and add it to the specified list of elements.
//
...
function makeElement(id, value)
{
    ...
    {
        id: "#" + id,
        value: value            // ? ? ? What's up with this WEIRDNESS ? ? ?
    };
}

// * * * * * * * * * 
//
//   I think everything is OK through TODO 7. 
//   In the instructions before TODO 8, checkout all the console.log debugging tips. 
//   Make use of these console.log stmts to debug work for TODO 8, 9 10. 
//
//   GOOD LUCK ! 
//
// * * * * * * * * * 
...
function checkForNewDirection(event) {
  ...
  */
  ...
  // FILL IN THE REST ~ ~ the work of TODO 7 ~ ~ ~ 
...
function moveSnake() {
  ...
  */
  for (var i = snake.length - 1; i >= 0; i--) {
    var currentSnakeSquare = snake[i];
    var snakeSquareInFront = snake[i - 1]; //?????
...
function moveBodyAToBodyB(bodyA, bodyB) {
  ...
  // - - -    looks like I'm moving B into A ? ? ?
  // bodyA.row       = bodyB.row;
  // bodyA.column    = bodyB.column;
  // bodyA.direction = bodyB.direction;

  // I'm going to try the other way!
  bodyB.row = bodyA.row;
  bodyB.column = bodyA.column;
  bodyB.direction = bodyA.direction;

...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ~~~ comment OUT current code (3:30pm) - PASTE orig. init.js above ~~~
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
var init = function (window) 
{
    ...
    /* ~~~~~~~~~~~~~~~~~~~~~~~
        ...
        This Function should check the position of a circle that is passed to the 
        Function. 
        If that circle drifts off the screen, this Function should move
        it to the opposite side of the screen.
        */
    ...
    /* ~~~~~~~~~~~~~~~~~~~~~~~
        ...
        game.checkCirclePosition = function(circle) 
        {
            ...
            {
                circle.x = 0; 
                console.log("reset circle to begin at LEFT")
            }

            // TODO 6 : YOUR CODE STARTS HERE //////////////////////

            // ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
            // ~ ~ Add checks to make sure circle does not drift off LEFT, TOP, BOTTOM     ~ ~ 
            // ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
            
            // if the circle has gone past the RIGHT side of the screen then place it on the LEFT
            if ( circle.x > canvas.width ) 
            {
                console.log("INSIDE check function - circle drifted off the RIGHT of screen")
                circle.x = 0; 
            }
            
            // if circle drifts past LEFT side of canvas, make it reappear on the RIGHT 
            if ( circle.x - circle.radius < 0 )  
            {
                circle.x = canvas.width + circle.radius;
            }

            // if circle drifts past BOTTOM side of canvas, make it reappear on the TOP 
            if ( circle.y > canvas.height + circle.radius )  
            {
                circle.y = 0 - circle.radius;
            }

            // if circle drifts past TOP side of canvas, make it reappear on the BOTTOM 
        ...
        app.addUpdateable(window.opspark.game);
    } // end of window.opspark.makeGame

}; // end of init for window
